...
function Login() {
  ...
  return (
    <div className="flex justify-center mx-auto min-w-screen bg-white bg-opacity-50 backdrop-blur-lg">
      {/* small screen */}
      <div className="bg-white mx-[20px] py-5 md:hidden">
        ...
        <form action="" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="bg-[#001F3F] text-[white]  py-1 text-[20px] px-2 w-full rounded-lg flex justify-center items-center"
            disabled={loading}
          >
            {loading ? (
