...
const PartnershipHero = () => {
  return (
    <div className="pt-32 pb-16 bg-hero-partners md:min-h-screen bg-no-repeat bg-center bg-cover relative">
      ...
      <div className=" pb-10  flex flex-col md:justify-center gap-16 md:h-screen ">
        <div className="text-center relative  text-white  font-semibold text-3xl md:text-5xl lg:text-6xl md:leading-[64px]">
          <h2 className="max-w-[1200px] mx-auto px-5">
            Partner with SeekersDream to Help Clients Find Their Ideal Home.
          </h2>
        </div>
